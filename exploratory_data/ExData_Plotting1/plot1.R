...
# make a base histogram of Global_active_power
hist(as.numeric(ds5$Global_active_power), col = "red", xlab = "Global Active Power (kilowatts)", main = "Global Active Power", xaxt = 'n')
